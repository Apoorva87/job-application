...
resume={
        'pm' : os.path.abspath('/Users/qatester/Downloads/Yatin.docx'),
        }
...
job_2_str="""- Revolutionized Home Lending Fee Strategy, boosting regulatory compliance and operational efficiency which slashed error rates dramatically from 7% to less than 1%, by implementing agile methodologies and cross-functional team management.
...
job_3_str=""" - Pioneered the SDLC for a groundbreaking product recommendation tool, markedly boosting digital customer engagement and securing the prestigious J.D. Power Associates Award for three consecutive years.
...
job_4_str="""- Developed a policy lookup tool for 12,000 mortgage loan originators, cutting lookup times and elevating match accuracy by 40%.
...
jobs=[
    ...
    'from' : '11/2021',
    'end' : '01/2024',
    'description' : job_1_str,
    'other' : ''
    },
    {
    'title' : 'Senior Vice President, Head of National Operations & Head of Fee Strategy & Governance',
    'company' : 'Wells Fargo',
    'location' : 'Dallas, TX',
    'current' : False,
    'from' : '04/2014',
    'end' : '11/2021',
    'description' : job_2_str,
    'other' : ''
    },
    {
    'title' : 'Vice President, Sales and Services System Office',
    'company' : 'Wells Fargo',
    'location' : 'Des Moines, IA',
    'current' : False,
    'from' : '05/2007',
    'end' : '04/2014',
    'description' : job_3_str,
    'other' : ''
    },
    {
